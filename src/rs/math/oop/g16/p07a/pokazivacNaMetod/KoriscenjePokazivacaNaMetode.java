package rs.math.oop.g16.p07a.pokazivacNaMetod;

import java.lang.reflect.*;

public class KoriscenjePokazivacaNaMetode {
    ...
    public static void main(String[] args) throws Exception {
        Method square = KoriscenjePokazivacaNaMetode.class.getMethod("kvadrat",
                double.class);
        System.out.println("------------------------------");
        ...
        Method nesto = KoriscenjePokazivacaNaMetode.class.getMethod("eNaXminus3",
                double.class);
        System.out.println("------------------------------");
