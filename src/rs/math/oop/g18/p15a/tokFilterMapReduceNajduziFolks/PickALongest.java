package rs.math.oop.g18.p15a.tokFilterMapReduceNajduziFolks;

import static rs.math.oop.g18.p15a.tokFilterMapReduceNajduziFolks.Folks.friends;
  ...
  public static void main(final String[] args) {
    {
      ...
      System.out.println("Total number of characters in all names: " + friends.stream().mapToInt(ime -> ime.length()).sum());
    }
    ...
    aLongName.ifPresent(ime -> System.out.println(String.format("A longest ime: %s", ime)));
