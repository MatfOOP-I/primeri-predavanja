package rs.math.oop.g10.p04a.anonimneKlasePoredjenjePriSortiranju;
...
public class VisekriterijumskoSortiranje
{
	...
	public static void main( String[] args )
	{
		...
		Arrays.sort(niske, new Comparator() {
			private int sumaAscci(String s){
				int ret =0;
				for(char ch: s.toCharArray())
					ret += (int)ch;
				return ret;
			...
			public int compare(Object o1, Object o2) {
				...
				String s1 = (String) o1;
				String s2 = (String) o2;
				int razlika = sumaAscci(s1)- sumaAscci(s2);
				if( razlika != 0)
					return razlika;
				return s1.compareTo(s2);
			}
		});
		System.out.println( "После сортирања по суми ASCII" );
		prikazi(niske);
	}
}
